...
function checarVitoria() {
  ...
  if(jogoTerminado){
    popup.innerHTML = `<span>Você ${resposta}.A palavra da vez era: <br><br><b>${palavraDavez.join("")}</b><section><button class="botão" onclick="jogarNovamente()">Tentar Novamente</button></section></span>`
